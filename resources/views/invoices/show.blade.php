...
@section('namepage')
<div class="container">
    <h3>ใบแจ้งหนี้ IV{{ str_pad($invoice->id_iv, 5, '0', STR_PAD_LEFT) }}</h3>
</div>
@endsection

@php
    $subTotal = $invoice->details->sum('total_amount');
...
<div class="container py-3">
    <div id="invoice">
        ...
        <div class="text-center mb-4">
            ...
            <p>
                โทร: 02-123-4567 |
                ที่อยู่: 189 หมู่ที่ 14 ตำบลสูงเนิน
                อำเภอสูงเนิน จ.นครราชสีมา 30170
            </p>
        </div>
        ...
        <div class="mb-4">
            ...
            <p>
                ...
                {{ \Carbon\Carbon::parse($invoice->date_iv)->format('d/m/Y') }}
            </p>
            <p>
                <strong>สถานะ:</strong>
                {{ $invoice->status }}
